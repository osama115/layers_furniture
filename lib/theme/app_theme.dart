...
/// A class that contains all theme configurations for the furniture e-commerce application.
class AppTheme {
  AppTheme._();

  // Color specifications based on Contemporary Minimalist Commerce design
  ...
  static const Color onSurfaceVariantLight =
      Color(0xFF6B6B6B); // Secondary text
  ...
  static const Color onPrimaryLight =
      Color(0xFFFFFFFF); // Text on green elements
  ...
  // Dark theme colors (adapted for furniture e-commerce)
  ...
  static const Color onSurfaceDark = Color(0xFFE5E5E5); // Light text on dark
  ...
  static const Color surfaceVariantDark =
      Color(0xFF1E1E1E); // Dark background variation
  static const Color onPrimaryDark =
      Color(0xFFFFFFFF); // Text on green elements
  static const Color successDark =
      Color(0xFF66BB6A); // Confirmation states dark
  static const Color errorDark = Color(0xFFEF5350); // Error states dark

  // Additional colors for furniture e-commerce
  ...
  /// Light theme optimized for furniture e-commerce
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for clean, minimal header
    ...
    // Card theme with minimal elevation for product cards
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 2.0,
    ...
    // Bottom navigation for persistent navigation
    ...
    // Button themes for commerce interactions
    ...
    // Typography theme using Inter font
    ...
    // Choice chip theme for category selection
    ...
    switchTheme: SwitchThemeData(
      ...
      trackColor: WidgetStateProperty.resolveWith((states) {
        ...
        return onSurfaceVariantLight.withValues(alpha: 0.3);
      }),
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    // Choice chip theme for dark mode
    chipTheme: ChipThemeData(
    ...
    switchTheme: SwitchThemeData(
      ...
      trackColor: WidgetStateProperty.resolveWith((states) {
        ...
        return onSurfaceVariantDark.withValues(alpha: 0.3);
      }),
    ),
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles for product names and cards
